...
static void CL_ParseTEntPacket(void)
{
    ...
    case TE_ELECTRIC_SPARKS:
        MSG_ReadPos(tent.pos1);
        MSG_ReadDir(tent.dir);
        break;
    ...
    case TE_TUNNEL_SPARKS:
        tent.count = MSG_ReadByte();
        MSG_ReadPos(tent.pos1);
        MSG_ReadDir(tent.dir);
        tent.color = MSG_ReadByte();
        break;
    ...
    case TE_GRAPPLE_CABLE:
        ...
        MSG_ReadPos(tent.pos1);
        MSG_ReadPos(tent.pos2);
        MSG_ReadPos(tent.offset);
        break;

    case TE_LIGHTNING:
        tent.entity1 = MSG_ReadShort();
        tent.entity2 = MSG_ReadShort();
        MSG_ReadPos(tent.pos1);
        MSG_ReadPos(tent.pos2);
        break;
